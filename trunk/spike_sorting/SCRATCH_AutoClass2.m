...
%% Run AutoClass Reporting utility
% * Only run after all channels have finished being processed with AutoClass

for i = 1:length(TANKS)
    
    resultsdir = ['C:\AutoClass_Files\AC2_RESULTS\' TANKS{i} '\'];
