function varargout = SchedWAVgui(varargin)
% SchedWAVgui(callingh,filestruct)
%
% DJS 2012

% Last Modified by GUIDE v2.5 29-Nov-2012 23:29:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SchedWAVgui_OpeningFcn, ...
                   'gui_OutputFcn',  @SchedWAVgui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SchedWAVgui is made visible.
function SchedWAVgui_OpeningFcn(hObj, evnt, h, varargin) %#ok<INUSL>
% Choose default command line output for SchedWAVgui
h.output = hObj;
...
% UIWAIT makes SchedWAVgui wait for user response (see UIRESUME)
% uiwait(h.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SchedWAVgui_OutputFcn(hObj, evnt, h)  %#ok<INUSL>
