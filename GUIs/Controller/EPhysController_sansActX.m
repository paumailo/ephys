function varargout = EPhysController_sansActX(varargin)
% h = EPhysController_sansActX
%
...
% Last Modified by GUIDE v2.5 09-Jan-2013 17:27:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EPhysController_sansActX_OpeningFcn, ...
                   'gui_OutputFcn',  @EPhysController_sansActX_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ephyscontroller_sansactx is made visible.
function EPhysController_sansActX_OpeningFcn(hObj, ~, h, varargin)
global G_DA G_TT

% Choose default command line output for ephyscontroller_sansactx
h.output = hObj;
...
function varargout = EPhysController_sansActX_OutputFcn(hObj, ~, h)  %#ok<INUSL>
